...
export default function Central() {
    return (
        <Fade top cascade>
            <section className="flex flex-col items-center text-3xl xl:text-4xl">
                <h1 className="title text-center my-16 mb-16">Informações da Pagina Central</h1>
                <form className="flex flex-row flex-wrap items-center justify-between">

                    <label className="text-xl items-center flex flex-col font-bold mb-5">
                        Titulo Central:
                        <input
                            type="text"
                            name="tituloCentral"
                            className=" border font-light text-sm border-slate-900 shadow-lg rounded-md w-96 ml-1.5 pl-1.5 h-8 "
                        />
                    </label>

                    <label className="text-xl items-center flex flex-col font-bold my-5 ">
                        Sub-titulo Central:
                        <input
                            type="text"
                            name="subtituloCentral"
                            className=" border font-light text-sm border-slate-900 shadow-lg rounded-md mb-5 w-96 pl-1.5 ml-1.5 h-8 "
                        />
                    </label>
                    ...
                    <div class="flex flex-col items-center justify-center w-full">
                        <label className="text-xl items-center flex flex-col font-bold my-5 mb-5" >Imagem central</label>
