...
export default function Projetos() {
    return (
        <Fade top cascade>
            <section className=" flex flex-col items-center text-3xl xl:text-4xl mr-96 ml-96">
                <h1 className="title text-center my-16 mb-14">Informações da Pagina de Projetos</h1>
                <form className="flex flex-row flex-wrap items-center justify-between">
                    <label className="text-xl items-center flex flex-col font-bold mb-2">
                        Titulo Projeto:
                        <input
                            type="text"
                            name="tituloProject"
                            className=" border font-light text-sm border-slate-900 shadow-lg rounded-md my-5 w-96 ml-1.5 pl-1.5 h-8 "
                        />
                    </label>

                    <label className="text-xl items-center flex flex-col font-bold my-5 mb-2">
                        Sub-titulo Projeto:
                        <input
                            type="text"
                            name="subtituloProject"
                            className=" border font-light text-sm border-slate-900 shadow-lg rounded-md my-5 mb-5 w-96 pl-1.5 ml-1.5 h-8 "
                        />
                    </label>
                    ...
                    <label className="text-xl items-center flex flex-col font-bold my-5 mb-2">
                        ...
                        <input
                            type="text"
                            name="repoProject"
                            className=" border font-light text-sm border-slate-900 shadow-lg rounded-md mb-5 w-96 my-5 pl-1.5 ml-1.5 h-8 "
                        />
                    </label>

                    <div class="flex flex-col items-center justify-center w-full">
                        <label className="text-xl items-center flex flex-col font-bold my-2 mb-5" >Insira a miniatura das tecnologias</label>
